...
carapace.defaults = {};
carapace.defaults['hook-port'] = 5000;

//
// Expose `evref` so that it can be used by `haibu-carapace` plugins
// `try/catch` to support `node@0.4.x` and `node@0.6.x`.
//
try { require('../build/default/evref') }
catch (ex) { require('../build/Release/evref') }

carapace.evref = evref;
