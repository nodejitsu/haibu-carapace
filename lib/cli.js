...
var defaultOptions = exports.defaultOptions = {
  debug: {
    description: 'Indicate if drone is in debug mode',
    boolean: true,
    default: false
  },
  plugin: {
    description: 'Indicate if drone should use the specified plugin',
    string: true
  },
  chroot: {
...
exports.rewrite = function (script, argv, override) {
  ...
  script = fs.realpathSync(require.resolve(path.resolve(script)));
